        ...
        <main className="container">
            ...
            <section className="rules">
                ...
                <ol className="rule-list">
                    <li>Fill the grid so that each <strong>row</strong> contains the allowed digits without
                        repetition.
                    </li>
                    <li>Each <strong>column</strong> must also contain the allowed digits without repetition.</li>
                    <li>Each outlined <strong>subgrid</strong> (3×3 on 9×9, 2×3 on 6×6) must contain the allowed
            ...
            <section className="credits">
                ...
                <ul className="credit-links">
                    ...
                    <li>GitHub: <a href="https://github.com/1ndigoLIU" target="_blank"
                                   rel="noopener noreferrer">github.com/1ndigoLIU</a></li>
                    <li>LinkedIn: <a href="https://www.linkedin.com/in/indigo-liu" target="_blank"
                                     rel="noopener noreferrer">linkedin.com/in/indigo-liu</a></li>
                </ul>

                <h3>Credits</h3>
                <p>
                    <a href="https://www.northeastern.edu/" target="_blank" rel="noopener noreferrer">
                        <img src="/assets/img/neu-logo.png" alt="Northeastern University logo"
